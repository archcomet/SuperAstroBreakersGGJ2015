//      Cog.js - Entity Component System framework v0.3.10 2014-10-17T18:58:19.627Z
...
(function () {
    ...
    var Entity = Node.extend('cog.Entity', {
        ...
        properties: {
            ...
            valid: { get: function () {
                return (this._manager && this._id) ? true : false;
            } }
        },
    ...
    var EntityManager = cog.Construct.extend('cog.EntityManager', {
        ...
        properties: {
            ...
            valid: { get: function () {
                return (this._director !== undefined);
            } }
        },
