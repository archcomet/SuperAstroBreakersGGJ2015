define([
    ...
    var BlackholeSystem = cog.System.extend('astro.BlackholeSystem', {
        ...
        'begin play event': function() {
            this.spawnBlackhole(300, 700, 500);
        },
        ...
        spawnBlackhole: function(radius, x, y) {


            var viewVector = this.cameraComponent.camera.position.clone();
            viewVector.sub(new THREE.Vector3(x, y, -radius/2));
